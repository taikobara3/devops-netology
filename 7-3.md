...
access_key:
  id: ajek8sl1pt8mplnh2a7h
  service_account_id: ajeprbivgjek6bde5rg2
  created_at: "2022-11-22T10:40:39.905526524Z"
  key_id: YCAJEmwWDIlIQ7xVyAh--xJYq
secret: YCOGxzPLEVZrnPuQfDnlRzaeJY5Y3hhVceWBW3bd
```
```
oleg@oleg-VB33:~/tf$ aws configure
AWS Access Key ID [None]: YCAJEmwWDIlIQ7xVyAh--xJYq
AWS Secret Access Key [None]: YCOGxzPLEVZrnPuQfDnlRzaeJY5Y3hhVceWBW3bd                 
